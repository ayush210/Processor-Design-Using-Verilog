...
for j in range(0,len(a)):
		if(a[j][3:]=='\n'):
			...
			if(output=="0100011"): #sw
					output =  binary_repr(int(num[2]),12)[0:7] +  reg_dict[int(num[0])]  +  reg_dict[int(num[1])]  +  funct3_dict[f[0]]  +  binary_repr(int(num[2]),12)[7:13]  +  output
			...
			if(output=="1100011"):
					output = binary_repr(int(num[2]),12)[0:7] +  reg_dict[int(num[1])] +  reg_dict[int(num[0])] +  funct3_dict[f[0]] +  binary_repr(int(num[2]),12)[7:13] +   output	
